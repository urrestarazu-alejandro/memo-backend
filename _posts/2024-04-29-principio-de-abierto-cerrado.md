...
Una segunda definición más clara es la que nos da Robert C. Martin (Desarrollo ágil de software: principios, patrones y prácticas - Prentice Hall, 2003):
...
Ahora supongamos que nuestro líder nos solicita una nueva funcionalidad, en este caso junto con el menú se va a incluir un postre. Entonces pasamos a una segunda versión:
...
Una implementación con un punto de extensión es haciendo el método cocinar un metodo virtual.
...
Aquí está el código, además le hemos agregado este truco en el constructor para asginar el servicio.
